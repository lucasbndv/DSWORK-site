        ...
        <div class="content">
            ...
            <div class="functions">
                ...
                <section>
                    ...
                    <header>
                        <a class="icon fa-vcard-o"
                        ><span class="label">Icon</span></a
                        >
                        <h3>Cadastro de contas</h3>
                    </header>
                    <p>
                        Clique para cadastrar pessoas para escrever notícias
                    </p>
                    </div>
                </section>
                <section>
                    <div class="content" id="news_register">
                    <header>
                        <a  class="icon fa-paper-plane-o"
                        ><span class="label">Icon</span></a
                        >
                        <h3>Adicionar Notícias</h3>
                    </header>
                    <p>Clique para adicionar notícias no site</p>
                    </div>
                </section>
            </div>
        </div>
